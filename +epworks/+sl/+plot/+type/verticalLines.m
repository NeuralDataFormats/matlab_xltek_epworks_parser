...
in.parent = [];
[local_options,line_options] = epworks.sl.in.removeOptions(varargin,fieldnames(in),'force_cell',true);
in = epworks.sl.in.processVarargin(in,local_options);
...
if flag1 || flag2
    ...
    pv = epworks.sl.obj.persistent_value;
    pv.value = struct;
